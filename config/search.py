...
search_terms = ["Software Engineer", "Software Developer","Nodejs Developer", "Python Developer", "React Developer", "Front End Developer", "Full Stack Developer", "Web Developer"]
...
location = ["Mumbai", "Pune", "Bengaluru", "Hyderabad", "Delhi", "Gurugram"]                      # (dynamic multiple select)
industry = ["Software Development", "IT Services and IT Consulting", "E-Commerce Services"]                      # (dynamic multiple select)
job_function = ["Engineering", "Information Technology"]                  # (dynamic multiple select)
job_titles = ["Software Engineer", "Backend Engineer", "Full Stack Engineer", "Software Development Engineer"]                    # (dynamic multiple select)
